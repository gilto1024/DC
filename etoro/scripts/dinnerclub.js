define(['jquery', 'rests', 'questions', 'story', 'view', 'history', 'utils'], function ($, rests, questions, story, view, history, utils) {
    ...
    function updateView(restList, story) {
        ...
        if (!story && currentQuestionIndex == 1 && backflag == false) {
        ...
        if (currentQuestionIndex == 4) {
            displayResults(matchingRests,userSelection);
    ...
    function displayResults(restList,story) {
        view.displayResults(restList,story);
    }

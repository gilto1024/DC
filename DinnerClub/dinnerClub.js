...
$(document).ready(function () {
    ...
    function setupEvents() {
        ...
        $container.on("click", ".next_option", function () {
            ...
            $end_result_text.fadeOut(500, function () {
                $end_result_text.text(resultArray[randOption].name);
    ...
    function writeOptions(options) {
        /* $("#result").empty();
         ...
         $("#result").append(options[i].name + '<br>');
         }*/
    ...
    /*function get_radio_value() {
     var divs = document.getElementsByName("selected");
    ...
    function init() {
        ...
        $('a').click(function () {
            ...
            $("html:not(:animated),body:not(:animated)").animate({ scrollTop:destination + 15}, 600, function () {

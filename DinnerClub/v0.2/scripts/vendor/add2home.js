define(['utils'], function (utils) {
    ...
    var addToHome = (function (w, addToHomeConfig) {
        var nav = w.navigator,
            ...
            intl = {
                en_us:'Always be ready for tonight: tap %icon and then <strong>Add to Home Screen</strong>.',
                he_il:'<span dir="rtl" style="text-align:right;display:inline-block">תמיד מוכנים להערב:<br/>לחצו %icon ואז <strong>הוסף למסך הבית</strong>.</span>'
            };
